...
import { listVariant, speakersVariants } from "@/core/framerVariables";

const Speakers = () => {
  const team = [
    {
      avatar: "/Martiana dialan.webp",
    ...
    <section className="py-14 px-4 sm:px-14">
      <div className=" mx-auto px-4 md:px-8">
        <div className="max-w-xl">
          <h2 className="text-5xl">Speakers</h2>
          <div className="divider w-24"></div>
          <p className="tex-xl mt-3">
            Our event gathers over 50 speakers. They include international
            company owners and young entrepreneurs that revolutionized the way
            of doing business. Here are some of them.
          </p>
        </div>
        ...
        <motion.div
         ...
         whileInView="visible"
         viewport={{ once: true }}
         className="relative w-full mt-10  mx-auto flex-items-center justify-center">
          <div className="ml-auto w-fit flex items-center justify-center gap-4">
            <div className="grid place-items-center cursor-pointer transition duration-200 ease-in review-swiper-button-prev w-14 h-14 rounded-full">
              <Image
            ...
            <div className="grid place-items-center cursor-pointer transition duration-200 ease-in review-swiper-button-next w-14 h-14 rounded-full">
              <Image
            ...
            {team.map((item, idx) => (
              <SwiperSlide key={idx}>
                ...
                variants={speakersVariants}
                  key={idx}
                  className="w-full mx-auto group sm:w-72 my-6  pb-4 rounded hover:scale-105 transition duration-300 ease-in-out "
                >
